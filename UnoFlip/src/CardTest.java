...
public class CardTest {
    ...
    public void getCardNum() {
        Card card = new Card(Card.Rank.EIGHT, Card.Colour.RED,null);
        Assert.assertEquals(Card.Rank.EIGHT,card.getCardNum());

        card = new Card(null, Card.Colour.RED,null);
    ...
    public void getCardColour() {
        ...
        card = new Card(Card.Rank.EIGHT, null,null);
    ...
    public void getSpecialType() {
        ...
        card = new Card(null, Card.Colour.BLACK, Card.Special.WILD_DRAW_TWO_CARDS);
